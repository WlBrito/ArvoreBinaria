...
void ArvoreAVL::rotacaoDupla_DirEsq(Nodo* P, Nodo* Q, Nodo* R) {
    ...
    Q->setPai(R);
    R->setPai(P);
    //Aqui está o pulo do gato, pois se nao "limparmos" o filho esquerdo de Q
    //ele vai continuar apontando para R gerando um ciclo, portanto entrando em loop
    //e dando o erro "falha de seguimentação"
    Q->setEsq(NULL);
